...
namespace GPayments.Requestor.TestLab.Controllers
{
    ...
    {
        private static log4net.ILog logger = log4net.LogManager.GetLogger(typeof(AuthV1Controller));
        ...
        /// <returns></returns>
        [HttpPost, Route("v1/auth/init/{messageCategory}")]
        public Message initAuth([FromBody]Message request, string messageCategory, [FromUri(Name = "trans-type")] string transType = null)
        {
        ...
        [HttpPost, Route("v1/auth/challenge/status")]
